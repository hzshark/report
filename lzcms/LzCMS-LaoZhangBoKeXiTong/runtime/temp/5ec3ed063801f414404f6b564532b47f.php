<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/web/blog_demo_lzcms_top/public_html/application/report/view/index/index.tpl.php";i:1502978539;s:84:"/www/web/blog_demo_lzcms_top/public_html/application/report/view/public/toper.tpl.php";i:1502978539;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree left_menu_ul">
              ...
              <li class="layui-nav-item ">
                <a href="<?php echo url('report/edit') ?>" target="main">
                  <i class="layui-icon">&#xe642;</i>
                  <cite>管理员信息</cite>
                </a>
              </li>
    ...
    <div class="layui-footer footer">
      <div class="layui-main">
        <p>2016 © <a target="_blank" href="http://www.phplaozhang.com">LzCMS</a></p>
      </div>
    </div>
</div>
...
layui.use(['layer', 'element','jquery','tree'], function(){
  ...
  jq('.top-nav-container .layui-nav-item').click(function(){
    ...
    jq('.report-iframe').attr('src',url);
    //出现遮罩层
    jq("#iframe-mask").show();
    //遮罩层消失
    jq("#report-iframe").load(function(){   
